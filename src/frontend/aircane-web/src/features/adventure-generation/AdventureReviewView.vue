    ...
    <div v-if="draft && !loading" class="flex gap-6">
      ...
      <div class="min-w-0 flex-1">
        ...
        <section v-if="activeSection === 'pitch' && draft.pitch" aria-labelledby="pitch-heading">
          ...
          <div class="space-y-4 rounded-lg border border-surface-700/50 bg-surface-850 p-6">
            <div>
        ...
        <section v-if="activeSection === 'outline' && draft.outline" aria-labelledby="outline-heading">
          ...
          <div class="space-y-3">
            <div
              ...
              :key="index"
              class="rounded-lg border border-surface-700/50 bg-surface-850 p-4"
            >
              <div class="flex items-center gap-3">
        ...
        <section v-if="activeSection === 'scenes' && draft.scenes?.length" aria-labelledby="scenes-heading">
          ...
          <div class="space-y-4">
            <details
              ...
              :key="scene.sceneId"
              class="group rounded-lg border border-surface-700/50 bg-surface-850"
            >
              ...
              <div class="border-t border-surface-700/50 px-4 py-4 space-y-4">
                <div>
        ...
        <section v-if="activeSection === 'treasure' && draft.treasure" aria-labelledby="treasure-heading">
          ...
          <div class="rounded-lg border border-surface-700/50 bg-surface-850 p-6 space-y-6">
            <div class="flex items-center gap-2">
