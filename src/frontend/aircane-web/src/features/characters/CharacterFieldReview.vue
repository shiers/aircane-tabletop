...
<template>
  <div class="mx-auto max-w-5xl space-y-6">
    ...
    <div class="flex items-center justify-between">
      <h1 class="text-2xl font-bold text-white">Review Imported Fields</h1>
    </div>
    ...
    <section aria-labelledby="field-review-heading">
      ...
      <div
        v-if="rows.length === 0"
        class="rounded-lg border border-surface-700/50 bg-surface-850 px-6 py-8 text-center text-gray-400"
      >
        No unmapped fields to review.
      </div>

      <div v-else class="overflow-x-auto rounded-xl border border-surface-700/50">
        <table class="w-full text-sm">
          <thead class="bg-surface-850 text-left text-xs font-semibold uppercase tracking-wider text-gray-400">
            <tr>
          ...
          <tbody class="divide-y divide-surface-700/50 bg-gray-950">
            <tr
